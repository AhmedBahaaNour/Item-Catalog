...
CLIENT_ID = json.loads(
    open('client_secrets11.json', 'r').read())['web']['client_id']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('client_secrets11.json', scope='')
...
# DISCONNECT - Revoke a current user's doken and rest their login_session.
